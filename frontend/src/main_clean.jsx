              ...
              <div style={{ background: "#fcfaf7", border: "1px solid #ebd9c5", borderRadius: "10px", padding: "16px", margin: "16px 0" }}>
                <label className="check-label" style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', cursor: 'pointer' }}>
                  ...
                  <span style={{ fontSize: '14px', color: '#333', lineHeight: '1.5' }}>
                    <strong>DECLARATION:</strong> I hereby promise that I will abide by Rules and Regulations during the competition. I agree to participate at my own risk and if any casualty or injury happens, it will be my own responsibility. I will not claim anything from organisers. I hereby declare that the above given information is true to my knowledge and I submit this form with my full consciousness.
                  </span>
                </label>
              </div>
